...
// //     useEffect(() => {
// //         if (user) router.push("/categories"); // ✅ Redirect to `/categories`
// //     }, [user, router]);
...
// //             if (!newUser) return;
// //             router.push("/categories"); // ✅ Redirect after login
// //         } catch (error: any) {
...
// //                 <a href="./ResetPassword" className="text-sm block text-brand-orange hover:underline w-full text-right">
// //                     Forgot Password?
// //                 </a>
// //             </button>
...
// //                 Not Registered?{" "}
// //                 <a href="./signup" className="text-blue-700 hover:underline" onClick={() => handleClick("register")}>
// //                     Create account
// //                 </a>
// //             </div>
// //         </form>
...
//       <button type="submit" className="w-full p-3 bg-blue-500 hover:bg-blue-600 rounded-md">
...
//       <form
//         className="w-full max-w-md bg-gray-800 p-8 rounded-lg shadow-xl space-y-6"
//         onSubmit={(e) => {
//           e.preventDefault();
...
//           whileTap={{ scale: 0.95 }}
//           type="submit"
//           className="w-full p-3 bg-blue-500 hover:bg-blue-600 rounded-lg text-white text-lg transition"
//         >
    ...
    >
      ...
      >
        ...
        <p
          ...
          className="text-blue-400 text-sm text-right cursor-pointer hover:underline"
        >
          Forgot Password?
        </p>
